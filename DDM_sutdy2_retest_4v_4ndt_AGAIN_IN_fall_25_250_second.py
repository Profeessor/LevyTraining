...
from simulator import DDM_Study2_retest_4v as sim_v2

import random 
random.seed(987650111111555555551212)
...
def draw_prior():
    ...
    return np.array([v1,v2,v3,v4,zr, a, ndt1, ndt2, ndt3, ndt4,sndt])
...
prior = bf.simulation.Prior(prior_fun=draw_prior,param_names=[r'$v1_w_a$',r'$v2_w_non$',r'$v3_nW_a$',r'$v4_nW_non$',r'$zr$', r'$a$', r'$ndt1_w_a$',r'$ndt2_w_non$',r'$ndt3_nW_a$',r'$ndt4_nW_non$',r'$sndt$'])
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/25_250_DDM_Study2_retest_AGAIN_IN_fall_25_250_second')
...
param_names=[r'$v1$',r'$v2$',r'$v3$',r'$v4$',r'$zr$', r'$a$', r'$ndt1$',r'$ndt2$',r'$ndt3$',r'$ndt4$',r'$sndt$']
...
plt.savefig('./DDM_figures_study2/study2_recovery.png')
