...
def simulate_diffusion_2_conds(theta, n_trials, dt=0.001, max_steps=15000):
    ...
    n_trials_c1 = n_trials
    
    
    v1, a, ndt,sndt,alpha = theta
    rts = simulate_diffusion_condition(n_trials_c1,v1,0.0,0.5,0.0, a, ndt,sndt,alpha, dt, max_steps)
    
    # Assign conditions
    cond_arr = np.zeros(n_trials_c1)
