...
def simulate_diffusion_2_conds(theta, n_trials, dt=0.001, max_steps=15000):
    ...
    v1,v2,a, ndt = theta
    rt_c1 = simulate_diffusion_condition(n_trials_c1,v1,0.0,0.5,0.0, a, ndt,0.0,2.0, dt, max_steps)
    rt_c2 = simulate_diffusion_condition(n_trials_c2, v2,0.0,0.5,0.0, a, ndt,0.0,2.0, dt, max_steps)
