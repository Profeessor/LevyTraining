...
def simulate_diffusion_2_conds(theta, n_trials, dt=0.001, max_steps=15000):
    ...
    v1,v2,v3,v4,zr, a, ndt1, ndt2, ndt3, ndt4,sndt = theta
    rt_c1_ass     = simulate_diffusion_condition(n_trials_c1_ass     ,v1,0.0,zr,0.0, a, ndt1,sndt,2.0, dt, max_steps)
    rt_c1_non_ass = simulate_diffusion_condition(n_trials_c1_non_ass, v2,0.0,zr,0.0, a, ndt2,sndt,2.0, dt, max_steps)
    rt_c2_ass     = simulate_diffusion_condition(n_trials_c2_ass,     v3,0.0,zr,0.0, a, ndt3,sndt,2.0, dt, max_steps)
    rt_c2_non_ass = simulate_diffusion_condition(n_trials_c2_non_ass, v4,0.0,zr,0.0, a, ndt4,sndt,2.0, dt, max_steps)
