...
def simulate_diffusion_2_conds(theta, n_trials, dt=0.001, max_steps=15000):
    ...
    n_trials_c1 = n_trials//2
    n_trials_c2 = n_trials - n_trials_c1
    
    
    v1,v2,sv,zr,szr, a, ndt,sndt,alpha = theta
    rt_c1 = simulate_diffusion_condition(n_trials_c1,v1,sv,zr,szr, a, ndt,sndt,alpha, dt, max_steps)
    rt_c2 = simulate_diffusion_condition(n_trials_c2, v2,sv,zr,szr, a, ndt,sndt,alpha, dt, max_steps)
