...
def simulate_diffusion_2_conds(theta, n_trials, dt=0.001, max_steps=15000):
    ...
    v1,v2,v3,v4, a, ndt1, ndt2, ndt3, ndt4,alpha = theta
    rt_c1_ass     = simulate_diffusion_condition(n_trials_c1_ass     ,v1,0.0,0.5,0.0, a, ndt1,0.0,alpha, dt, max_steps)
    rt_c1_non_ass = simulate_diffusion_condition(n_trials_c1_non_ass, v2,0.0,0.5,0.0, a, ndt2,0.0,alpha, dt, max_steps)
    rt_c2_ass     = simulate_diffusion_condition(n_trials_c2_ass,     v3,0.0,0.5,0.0, a, ndt3,0.0,alpha, dt, max_steps)
    rt_c2_non_ass = simulate_diffusion_condition(n_trials_c2_non_ass, v4,0.0,0.5,0.0, a, ndt4,0.0,alpha, dt, max_steps)
