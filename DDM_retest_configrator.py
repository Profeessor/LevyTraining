...
plt.savefig('./Figures_DDM/loss_retest.png')
...
param_names = [r'$v1$',r'$v2$',r'$zr$', r'$a$', r'$ndt$',r'$sndt$']
...
plt.savefig('./Figures_DDM/recovery_retest.png')
