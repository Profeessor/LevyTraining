...
amortizer = bf.amortizers.AmortizedPosterior(inference_net, summary_net, name='S2_25_250')
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/Study2_retest_25_250_trl')

num_val = 300
val_sims = generative_model(num_val)


h = trainer.train_online(epochs=140, iterations_per_epoch=1000, batch_size=256, validation_sims=val_sims)
...
plt.savefig('./figures_study2/study2_25_250_recovery.png')
