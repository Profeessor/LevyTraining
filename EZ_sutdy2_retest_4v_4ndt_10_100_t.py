...
def prior_N(n_min=10, n_max=100):
...
amortizer = bf.amortizers.AmortizedPosterior(inference_net, summary_net, name='v4_endt4_equive')
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/EZ_Study2_retest_10_100')

num_val = 300
val_sims = generative_model(num_val)


h = trainer.train_online(epochs=11, iterations_per_epoch=1000, batch_size=256, validation_sims=val_sims)
plt.savefig('./figures_study2/EZ_10_100_loss.png')
...
plt.savefig('./figures_study2/EZ_10_100_recovery.png')
