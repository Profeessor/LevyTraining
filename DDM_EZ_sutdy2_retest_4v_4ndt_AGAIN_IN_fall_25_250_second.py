...
from simulator import EZ_DDM_Study2_retest_4v as sim_v2

import random 
random.seed(987650111111555555551212123)
...
def draw_prior():
   ...
   # sndt =np.random.uniform(low=0.0,high=0.3)
    ...
    return np.array([v1,v2,v3,v4, a, ndt1, ndt2, ndt3, ndt4])
...
prior = bf.simulation.Prior(prior_fun=draw_prior,param_names=[r'$v1_w_a$',r'$v2_w_non$',r'$v3_nW_a$',r'$v4_nW_non$', r'$a$', r'$ndt1_w_a$',r'$ndt2_w_non$',r'$ndt3_nW_a$',r'$ndt4_nW_non$'])
...
summary_net = bf.networks.InvariantNetwork(summary_dim=64,num_equiv=6)
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/notTrainedBefoe_train_EZ_25_250_DDM_Study2_retest_AGAIN_IN_fall_25_250_second')
...
param_names=[r'$v1$',r'$v2$',r'$v3$',r'$v4$', r'$a$', r'$ndt1$',r'$ndt2$',r'$ndt3$',r'$ndt4$']
...
plt.savefig('./DDM_figures_study2/EZ_study2_recovery.png')
