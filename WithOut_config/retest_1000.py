...
generative_model = bf.simulation.GenerativeModel(prior,simulator,name='retest')
...
amortizer = bf.amortizers.AmortizedPosterior(inference_net, summary_net, name='retest')
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/retest_v2_1000')
...
plt.savefig('./figures_retest_1000/loss.png')
...
plt.savefig('./figures_retest_1000/recovery.png')
