...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/full_py_128_bach_size')
...
plt.savefig('./figures_full/128_bach_loss.png')
...
plt.savefig('./figures_full/128_bach_recovery.png')
