...
summary_net = bf.networks.InvariantNetwork(summary_dim=32,num_equiv=3)
...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/full_py_dim32')
...
plt.savefig('./figures_full/loss_dim32.png')
...
plt.savefig('./figures_full/recovery_dim32.png')
