...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/full_py_1000')
...
plt.savefig('./figures_full_1000/loss.png')
...
plt.savefig('./figures_full_1000/recovery.png')
