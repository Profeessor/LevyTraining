...
trainer = bf.trainers.Trainer(
    ...
    checkpoint_path='./checkpoints/full_py_coup_6')

num_val = 300
val_sims = generative_model(num_val)

h = trainer.train_online(epochs=500, iterations_per_epoch=1000, batch_size=64, validation_sims=val_sims)

f = bf.diagnostics.plot_losses(h['train_losses'], h['val_losses'])

plt.savefig('./figures_full/coup6_loss.png')
...
plt.savefig('./figures_full/coup6_recovery.png')
